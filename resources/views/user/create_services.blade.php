    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="row mt-5 justify-content-center" data-aos="fade-up">
          ...
          <div class="col-sm-6">
            <form method="POST" action="{{ route('store_services') }}" role="form" class="php-email-form" enctype="multipart/form-data">
            @csrf
              ...
              <div class="row">
                ...
                <div class="col-md-12 form-group" style="margin-top:20px;">
                    ...
                    <input type="hidden" class="@error('icon') is-invalid @enderror" name="icon" id="icon" placeholder="icon" />
                    <div class="row">
                        @if (count($icon_array) > 0)
                            @foreach ($icon_array as $eachIcon)
                                <div class="col-sm-2" >

                                    <div class="icon-box icon-holder" data-icon="{{ $eachIcon }}" style="text-align: center; border: 1px solid black; cursor:pointer;" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="col-md-12 form-group mt-4">
                  <div class="text-center"><button style="width: 100%;" type="submit">CREATE</button></div>
                </div>
