    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="row mt-5 justify-content-center" data-aos="fade-up">
          ...
          <div class="col-sm-6">
            <form method="POST" action="{{ route('update_partner', ['uniqueId'=>$editPartner->unique_id]) }}" role="form" class="php-email-form" enctype="multipart/form-data">
            @csrf
              <div class="row">
                ...
                <div class="col-md-12 form-group" style="margin-top:20px;">
                <label for="image">Upload Partner`s Logo</label>
                <input type="hidden" name="unique_id" value="{{$editPartner->unique_id}}" />
                <input type="file" value="{{$editPartner->image}}" name="image" placeholder="Choose image" id="image">
                     @error('title')
